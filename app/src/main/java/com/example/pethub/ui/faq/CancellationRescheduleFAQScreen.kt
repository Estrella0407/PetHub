...
@Composable
fun CancellationRescheduleFAQScreen(
    viewModel: CancellationRescheduleFAQViewModel = hiltViewModel(),
    onNavigateBack: () -> Unit
) {
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text("Cancellation FAQ", fontWeight = FontWeight.Bold,color=DarkBrown) },
                navigationIcon = {
