        ...
        when (uiState) {
            ...
            is AdminDashboardUiState.Success -> {
                AdminDashboardContent(
                    ...
                    onMonthlySalesReportClick = onNavigateToMonthlySalesReport,
                    onServiceUsageReportClick = onNavigateToServiceUsageReport
                )
            }
        }
    }
...
fun AdminDashboardContent(
    ...
    onMonthlySalesReportClick: () -> Unit,
    onServiceUsageReportClick: () -> Unit
) {
    LazyColumn(
        modifier = modifier
            .fillMaxSize()
        ...
        item {
            Row(
                ...
                ReportCard(
                    ...
                    onClick = onMonthlySalesReportClick
                )
                ReportCard(
                    title = "Service Usage\nReport",
                    modifier = Modifier.weight(1f),
                    onClick = onServiceUsageReportClick
                )
            }
        }
