...
@Composable
fun PetParentsFAQScreen(
    viewModel: PetParentsFAQViewModel = hiltViewModel(),
    onNavigateBack: () -> Unit
) {
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text("Pet Parents FAQ", fontWeight = FontWeight.Bold,color=DarkBrown) },
                navigationIcon = {
...
private fun ExpandableFAQItem(qaItem: QAItem) {
    ...
    Column {
        ...
        // Answer Text (Animated Visibility)
        AnimatedVisibility(visible = isExpanded) {
            Text(
                text = formattedAnswer, // Use the formatted AnnotatedString
