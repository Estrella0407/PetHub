...
@Composable
fun PetInformationFAQScreen(
    viewModel: PetInformationFAQViewModel = hiltViewModel(),
    onNavigateBack: () -> Unit
) {
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text("Pet Information FAQ", fontWeight = FontWeight.Bold,color=DarkBrown) },
                navigationIcon = {
