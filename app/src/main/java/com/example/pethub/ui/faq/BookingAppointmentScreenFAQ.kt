...
@Composable
fun BookingAppointmentScreenFAQ(
    viewModel: BookingAppointmentViewModelFAQ = hiltViewModel(),
    onNavigateBack: () -> Unit
) {
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text("Booking FAQ", fontWeight = FontWeight.Bold,color=DarkBrown) },
                navigationIcon = {
